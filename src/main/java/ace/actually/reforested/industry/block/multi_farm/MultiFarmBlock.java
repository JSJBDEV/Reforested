...
public class MultiFarmBlock extends Block implements BlockEntityProvider {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new MultiFarmBlockEntity(pos,state);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof MultiFarmBlockEntity) {
                ItemScatterer.spawn(world, pos, (MultiFarmBlockEntity)blockEntity);
                // update comparators
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, Reforested.MULTIFARM_BLOCK_ENTITY, MultiFarmBlockEntity::tick);
    }
