...
public class RLanguageProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(RegistryWrapper.WrapperLookup registryLookup, TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add("tag.item.reforested.plantings","Plantings (Stuff you get from grass and flowers)");
        ...
        translationBuilder.add(Reforested.DIGGING_BACKPACK,"Digger's Backpack");
        translationBuilder.add(Reforested.BOTANISTS_BACKPACK,"Botanist's Backpack");
        ...
        translationBuilder.add("information.reforested.backpacks","using fairly basic materials you can craft a Digger's Backpack (and others!) it does not have a screen of its own but if it's in pickup mode (activated by shift-using it) it will automagically pick up any cobble sand or gravel (or plant matter in the case of a botanist's backpack) and put it inside, up to 500 items per type. It will only take in items not on your hotbar, and you can place all the items in the backpack into an inventory by shift-using it on a chest, a barrel or anything with storage slots");
    }
}
