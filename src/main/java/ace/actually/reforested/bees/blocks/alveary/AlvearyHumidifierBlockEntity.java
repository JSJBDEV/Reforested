...
public class AlvearyHumidifierBlockEntity extends BlockEntity {
    ...
    public AlvearyHumidifierBlockEntity(BlockPos pos, BlockState state) {
        super(Reforested.ALVEARY_HUMIDIFIER_BLOCK_ENTITY, pos, state);
    ...
    public static void tick(World world, BlockPos pos, BlockState state, AlvearyHumidifierBlockEntity be)
    {
        if(be.fluidStorage.amount>0)
        {
